...
def neff(width, wavelength, te_or_tm):
    ...
    if isinstance(te_or_tm, str):
        ...
        if te_or_tm[0:2] == "tm":
            if wavelength_nm in neff_tm_list[int(te_or_tm[2:3])] and width in neff_tm_list[int(te_or_tm[2:3])][wavelength_nm]:
        ...
        if te_or_tm[0:2] == "te" and int(te_or_tm[2:3]) < te_number:
            ...
            if not te_or_tm[0:2] == "tm":
                raise ValueError("There is no TE" + te_or_tm[2:3] + " for wavelength: " + str(wavelength_nm) + " & Width: " + str(width))
        ...
        if te_or_tm[0:2] == "tm" and int(te_or_tm[2:3]) < tm_number:
            ...
            if not te_or_tm[0:2] == "te":
                raise ValueError("There is no TM" + te_or_tm[2:3] + " for wavelength: " + str(wavelength_nm) + " & Width: " + str(width))
...
def polarization_frac(width, wavelength, te_or_tm):
    ...
    if isinstance(te_or_tm, str):
        ...
        if te_or_tm[0:2] == "tm":
            if wavelength_nm in pol_tm_list[int(te_or_tm[2:3])] and width in pol_tm_list[int(te_or_tm[2:3])][wavelength_nm]:
