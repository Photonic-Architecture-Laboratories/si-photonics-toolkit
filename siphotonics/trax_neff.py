...
effective_index_te0, width_data_te0, wav_data_te0 = \
    _read_effective_index("neff_te0_fitted_Si_fitted_SiO2_width_240_10_700_wav_1200_10_1700.csv")

effective_index_tm0, _, _ = \
    _read_effective_index("neff_tm0_fitted_Si_fitted_SiO2_width_240_10_700_wav_1200_10_1700.csv")

effective_index_te1, _, _ = \
    _read_effective_index("neff_te1_fitted_Si_fitted_SiO2_width_240_10_700_wav_1200_10_1700.csv")

effective_index_tm1, _, _ = \
    _read_effective_index("neff_tm1_fitted_Si_fitted_SiO2_width_240_10_700_wav_1200_10_1700.csv")

effective_index_te2, _, _ = \
    _read_effective_index("neff_te2_fitted_Si_fitted_SiO2_width_240_10_700_wav_1200_10_1700.csv")
...
def neff_te0(width, wavelength):
    """
        ...
        :return: Effective Index value(s).
        """
    return ndimage.map_coordinates(effective_index_te0,
...
def neff_tm0(width, wavelength):
    """
        ...
        :return: Effective Index value(s).
        """
    return ndimage.map_coordinates(effective_index_tm0,
                                   [(width - width_min_te0) * ((width_size_te0 - 1) / (width_max_te0 - width_min_te0)),
                                    (wavelength - wav_min_te0) * ((wav_size_te0 - 1) / (wav_max_te0 - wav_min_te0))],
                                   order=1)
...
def neff_te1(width, wavelength):
    """
        ...
        :return: Effective Index value(s).
        """
    return ndimage.map_coordinates(effective_index_te1,
                                   [(width - width_min_te0) * ((width_size_te0 - 1) / (width_max_te0 - width_min_te0)),
                                    (wavelength - wav_min_te0) * ((wav_size_te0 - 1) / (wav_max_te0 - wav_min_te0))],
                                   order=1)
...
def neff_tm1(width, wavelength):
    """
        ...
        :return: Effective Index value(s).
        """
    return ndimage.map_coordinates(effective_index_tm1,
                                   [(width - width_min_te0) * ((width_size_te0 - 1) / (width_max_te0 - width_min_te0)),
                                    (wavelength - wav_min_te0) * ((wav_size_te0 - 1) / (wav_max_te0 - wav_min_te0))],
                                   order=1)
...
def neff_te2(width, wavelength):
    """
        ...
        :return: Effective Index value(s).
        """
    return ndimage.map_coordinates(effective_index_te2,
                                   [(width - width_min_te0) * ((width_size_te0 - 1) / (width_max_te0 - width_min_te0)),
                                    (wavelength - wav_min_te0) * ((wav_size_te0 - 1) / (wav_max_te0 - wav_min_te0))],
                                   order=1)
